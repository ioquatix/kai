...
#ifndef __GNUC__
#define KAI_ENSURE(e) ::Kai::InternalError::ensure_handler(e, #e, __PRETTY_FUNCTION__, __FILE__, __LINE__)
#else
#define KAI_ENSURE(e) ::Kai::InternalError::ensure_handler(e, #e, __func__, __FILE__, __LINE__)
#endif
